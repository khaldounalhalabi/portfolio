...
values
  (
    '9e41f790-9791-49ee-a79f-6d6cc6c3f44d',
    'cohort-hcm',
    'Cohort HCM',
    ...
    '[{"name":"Laravel","icon":"terminal","detail":"Core Logic & API"},{"name":"React","icon":"layers","detail":"Dynamic UI"},{"name":"Next.js","icon":"sparkles","detail":"SSR & Performance"},{"name":"PostgreSQL","icon":"database","detail":"Data Persistence"}]'::jsonb,
    true,
    1
  ),
  (
